...
:::warning[Verifique `moved` em cada item]
...
:::info[Contrato de erro diferente]
Ao contrário de [Mover card](./mover-card.md), este endpoint responde `400` com a mensagem de erro em texto quando a etapa de destino está inativa, sem o corpo `{ "error": "stage_inactive" }`.
:::
