...
:::warning[A empresa vem sempre do token]
...
3. Movimente:
   - [Mover card](./mover-card.md) - um card entre etapas do mesmo funil
   - [Mover em massa](./mover-cards-em-massa.md) - vários cards de uma vez
   - [Trocar de funil](./trocar-de-funil.md) - mudar o card de funil
   - [Mover por telefone](./mover-por-telefone.md) - sem precisar do `cardId`

Os dois primeiros passos estão em [Funis e etapas](./funis-e-etapas.md).
...
:::info[Além da movimentação]
Esta seção detalha o fluxo de movimentação de cards. Os demais endpoints de CRM (CRUD de cards, funis, etapas, automações, filtros e pipelines) estão listados em [Referência completa](/api/crm/referencia).
:::
