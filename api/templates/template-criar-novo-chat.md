...
:::info[O body é igual ao de `send-template`]
O corpo do request é o mesmo nos dois endpoints. O que muda é o **painel usado** para gerenciar os templates: **Gupshup** ou **Meta**.
:::
...
```json
{
    ...
    "canalId": 8181,
    "mensagemInicial": {
        "texto": "Oi Gian, tudo bem? Confirmando nossa reunião de hoje às 10. Me responde com um 'sim' pra eu garantir seu lugar!",
        "tipoMensagem": 9,
        "cloudApiTemplateName": "2267be99-0000-4c2f-9a1b-9ee22e4841f8",
        "params": ["Gian", "10"]
    },
...
```json
{
    ...
    "canalId": 8181,
    "mensagemInicial": {
        "texto": "Oi Gian, tudo bem? Confirmando nossa reunião de hoje às 10. | [Sim] | [Reagendar]",
        "tipoMensagem": 9,
        "cloudApiTemplateName": "2267be99-0000-4c2f-9a1b-9ee22e4841f8",
        "params": ["Gian", "10"]
    },
...
*Documentação atualizada: 2026-08-05*
