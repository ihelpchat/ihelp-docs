...
description: "Veja como buscar chats em massa, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
contentType: referencia
method: GET
endpoint: /customers/filtered-calls/{id}
---

1. Criar um filtro no topo da aba de atendimento:

![Tela do iHelp: Buscar chats em massa](/img/api/Pasted%20image%2020260409105659.png)
2. Selecione todos os canais da empresa:

![Tela do iHelp: Buscar chats em massa](/img/api/Pasted%20image%2020260409105743.png)
...
![Tela do iHelp: Buscar chats em massa](/img/api/Pasted%20image%2020260409110021.png)
...
![Tela do iHelp: Buscar chats em massa](/img/api/Pasted%20image%2020260409110412.png)
