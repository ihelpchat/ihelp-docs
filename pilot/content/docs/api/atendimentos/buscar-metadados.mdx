...
description: "Veja como buscar metadados do atendimento, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
contentType: referencia
method: GET
endpoint: /customers/call-chat/{idRef}
---
