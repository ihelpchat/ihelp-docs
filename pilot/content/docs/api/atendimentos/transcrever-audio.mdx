...
description: "Veja como transcrever áudio, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
contentType: referencia
method: POST
endpoint: /customers/transcribe-audio
---
...
<Callout type="warn" title="A resposta virá vazia">
