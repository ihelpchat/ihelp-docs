...
- Cards que estejam em um funil diferente do da etapa de destino saem como `skipped`. Para mudar de funil, use [Trocar de funil](./trocar-de-funil), um card por vez.
