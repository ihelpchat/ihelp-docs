...
Ao contrário de [Mover card](./mover-card), este endpoint responde `400` com a mensagem de erro em texto quando a etapa de destino está inativa, sem o corpo `{ "error": "stage_inactive" }`.
</Callout>
