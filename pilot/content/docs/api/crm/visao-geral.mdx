...
3. Movimente:
   - [Mover card](./mover-card) - um card entre etapas do mesmo funil
   - [Mover em massa](./mover-cards-em-massa) - vários cards de uma vez
   - [Trocar de funil](./trocar-de-funil) - mudar o card de funil
   - [Mover por telefone](./mover-por-telefone) - sem precisar do `cardId`

Os dois primeiros passos estão em [Funis e etapas](./funis-e-etapas).
