...
- **Por link** - a mídia já está em uma URL pública e o iHelp a busca pela URL. Usa o mesmo endpoint da [Mensagem comum](./mensagem-comum) (`send-message`), sem subir bytes.
