---
title: "Enviar mídia"
description: "Veja como enviar mídia, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
...
- **Por link** - a mídia já está em uma URL pública e o iHelp a busca pela URL. Usa o mesmo endpoint da [Mensagem comum](/api/mensagens/mensagem-comum) (`send-message`), sem subir bytes.
...
<Callout type="info" title="Documentos">
...
<Callout type="warn" title="Limites por canal">
