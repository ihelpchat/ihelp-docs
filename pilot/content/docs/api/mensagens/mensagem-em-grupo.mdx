...
description: "Consulte mensagem em grupo, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
contentType: referencia
method: POST
endpoint: /Groups/sendGroupMessage
---
...
![Tela do iHelp: Mensagem em grupo](/img/api/zen_Lr5FVdcZNv.png)

**Exemplo de campos Form Data no request POST:**

![Tela do iHelp: Mensagem em grupo](/img/api/Pasted%20image%2020260424125712.png)
