...
Menu de lista é uma mensagem interativa: o cliente toca em um botão e o WhatsApp abre uma lista de opções para ele escolher. Usa o mesmo endpoint da [Mensagem comum](./mensagens/mensagem-comum), com `messageType: 21` e o objeto `interactiveMetaMessage`.
