...
description: "Veja como pegar id do template, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
...
<Callout type="warn" title="Não inclua os %22">
...
<Callout type="idea" title="Resumo">
