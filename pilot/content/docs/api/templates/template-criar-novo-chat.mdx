...
description: "Veja como criar novo chat, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
contentType: referencia
method: POST
endpoint: /customers/add-new-call
---
...
<Callout type="info" title="O body é igual ao de `send-template`">
