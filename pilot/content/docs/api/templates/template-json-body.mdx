...
description: "Consulte json body pronto, com parâmetros e exemplos de requisição e resposta na API do iHelp."
source: api
...
![Tela do iHelp: JSON Body pronto](/img/api/explorer_ejWZE4Y5hl.png)
