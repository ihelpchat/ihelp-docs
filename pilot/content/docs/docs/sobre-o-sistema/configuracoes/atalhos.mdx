---
title: "Atalhos"
description: "Crie respostas rápidas com texto, mídia ou áudio para agilizar mensagens repetidas durante o atendimento."
source: produto
contentType: guia
---

Crie respostas rápidas com texto, mídia ou áudio para agilizar mensagens repetidas durante o atendimento.
...
![Tela do iHelp: Como criar um novo Atalho](/img/help/glu6YF23zAZVAcd0vn7W.png)

Vá para as configurações do iHelp e busque a opção “Atalhos”.

Crie um novo atalho:

![Tela do iHelp: Como criar um novo Atalho](/img/help/wsbjgpUjp5s1jn2fM1Ml.png)

Defina o texto que você usa frequentemente e que deseja salvar como atalho.

Escolha uma palavra-chave:

![Tela do iHelp: Como criar um novo Atalho](/img/help/x0SVJrl0yzEnmPBIvyxM.png)
