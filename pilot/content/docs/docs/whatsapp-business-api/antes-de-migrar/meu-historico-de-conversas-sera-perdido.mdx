...
description: "Sim — e é importante entender exatamente o que isso significa antes da migração para não ter surpresas."
source: produto
contentType: faq
---
...
<Callout type="info" title="Já usava o iHelpChat antes da migração?">
...
<Callout type="warn" title="Não entre em contato com clientes no dia da criação da API">
