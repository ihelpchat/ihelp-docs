...
description: "Se a empresa decidir deixar de usar a API Oficial e voltar a operar o número pelo aplicativo WhatsApp Business ou Messenger, esse processo é chamado de downgrade."
source: produto
