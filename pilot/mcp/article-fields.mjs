...
export const articleSchema = z.strictObject({
  ...
  assistantRouting: z.strictObject({ actions: z.array(z.string().min(2)).min(1), objects: z.array(z.string().min(2)).min(1), anchors: z.array(z.string().min(2)).min(1), ownFeatures: z.array(z.string().min(2)).min(1).optional() }).optional(),
